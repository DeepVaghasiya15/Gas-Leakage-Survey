...
class DiameterOfPipelineUGBranch extends StatelessWidget {
  const DiameterOfPipelineUGBranch({Key? key}) : super(key: key);
          ...
          GridView.count(
            ...
            children: List.generate(
              ...
              diameterOfPipelineUGBranch.length,
                  (index) {
                String type = diameterOfPipelineUGBranchNumber[index];
                String otherArray = diameterOfPipelineUGBranch[
